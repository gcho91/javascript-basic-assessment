...
function removeItem (array, string) {
    var filtered = array.filter(function(a) {return a !== string})
    return filtered;
  }
...
function getValueOfProperty(object, prop) {
	//if family, brother, return "Brian"
	return object[prop];
}
...
console.log(makeChatMessage("hi", "gloria"))
